...
class Settings(BaseSettings):
    ...
    # Database
    database_url: str = (
        "sqlite+aiosqlite:///:memory:"  # Use this for docker - postgresql+asyncpg://postgres:postgres@db:5432/eventdb
    )
    # database_url: str = Field(..., env="DATABASE_URL")
    # database_url_sync: str = Field(..., env="DATABASE_URL_SYNC")
    database_url_sync: str = (
        "sqlite:///:memory:"  # Use this for docker - postgresql+asyncpg://postgres:postgres@db:5432/eventdb
    )
